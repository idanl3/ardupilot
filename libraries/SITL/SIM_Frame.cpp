...
{
    Motor(AP_MOTORS_MOT_1,    20.5f,  AP_MOTORS_MATRIX_YAW_FACTOR_CCW*1.5,  1),
    Motor(AP_MOTORS_MOT_2,  -159.5f,  AP_MOTORS_MATRIX_YAW_FACTOR_CCW*1.5,  5),
    Motor(AP_MOTORS_MOT_3,   36.9f,  AP_MOTORS_MATRIX_YAW_FACTOR_CW, 2),
    Motor(AP_MOTORS_MOT_4,  159.5f,  AP_MOTORS_MATRIX_YAW_FACTOR_CW*1.5, 4),
    Motor(AP_MOTORS_MOT_5,  -20.5f,  AP_MOTORS_MATRIX_YAW_FACTOR_CW*1.5, 8),
    Motor(AP_MOTORS_MOT_6, -143.2f,  AP_MOTORS_MATRIX_YAW_FACTOR_CW, 6),
    Motor(AP_MOTORS_MOT_7,  -36.9f,  AP_MOTORS_MATRIX_YAW_FACTOR_CCW,  7),
    Motor(AP_MOTORS_MOT_8,   143.2f,  AP_MOTORS_MATRIX_YAW_FACTOR_CCW,  3)
};
