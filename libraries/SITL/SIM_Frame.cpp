...
{
    Motor(AP_MOTORS_MOT_1,    20.5f,  AP_MOTORS_MATRIX_YAW_FACTOR_CCW,  1),
    Motor(AP_MOTORS_MOT_2,  -159.5f,  AP_MOTORS_MATRIX_YAW_FACTOR_CCW,  5),
    Motor(AP_MOTORS_MOT_3,   36.9f,  AP_MOTORS_MATRIX_YAW_FACTOR_CW, 2),
    Motor(AP_MOTORS_MOT_4,  159.5f,  AP_MOTORS_MATRIX_YAW_FACTOR_CW, 4),
    Motor(AP_MOTORS_MOT_5,  -20.5f,  AP_MOTORS_MATRIX_YAW_FACTOR_CW, 8),
